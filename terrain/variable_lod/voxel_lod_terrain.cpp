...
const VoxelMeshMap<VoxelMeshBlockVLT> &VoxelLodTerrain::get_mesh_map(int lod_index) const {
	const int lod_count = get_lod_count();
	ERR_FAIL_COND_V(lod_index < 0 || lod_index >= lod_count, _mesh_maps_per_lod[0]);
	return _mesh_maps_per_lod[lod_index];
}
